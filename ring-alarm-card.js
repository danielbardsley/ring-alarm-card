...
compact_mode: false</pre
    ...
    `}static renderControlButtons(t,e,r,i){const a=gt.getControlActions(),o=t?gt.getActiveAction(t.state):null,n=gt.areControlsDisabled(t?.state);return W`
      <div
        class="control-buttons"
        role="group"
        aria-label="Alarm control buttons"
      >
        ${a.map(t=>{const i=e.get(t.type)||{isLoading:!1,isDisabled:!1,hasError:!1},a={isActive:o===t.type,isLoading:i.isLoading,isDisabled:n||i.isDisabled,hasError:i.hasError};return void 0!==i.isTransitionTarget&&(a.isTransitionTarget=i.isTransitionTarget),void 0!==i.transitionProgress&&(a.transitionProgress=i.transitionProgress),void 0!==i.transitionRemainingSeconds&&(a.transitionRemainingSeconds=i.transitionRemainingSeconds),ft.renderControlButton(t,a,()=>r(t.type))})}
    ...
    `}static generateAriaLabel(t,e){const r={disarm:"Set alarm to disarmed",arm_home:"Arm alarm in home mode",arm_away:"Arm alarm in away mode"}[t.type];if(e.isTransitionTarget&&void 0!==e.transitionRemainingSeconds){const r=Math.ceil(e.transitionRemainingSeconds);return`${"disarm"===t.type?"Disarming":"arm_home"===t.type?"Arming home":"Arming away"} - ${r} second${1!==r?"s":""} remaining`}return r}}class yt{static isTransitionalState(t){return["arming","pending","disarming"].includes(t)}static getTransitionTarget(t,e){if(!yt.isTransitionalState(t))return null;if("arming"===t){const t=e.targetState??e.target_state??e.next_state??e.arm_mode??e.mode;if(t){const e=t.toLowerCase();if("armed_home"===e||"home"===e||"arm_home"===e)return"arm_home";if("armed_away"===e||"away"===e||"arm_away"===e)return"arm_away"}return"arm_away"}if("pending"===t){const t=e.targetState??e.target_state;if(t){const e=t.toLowerCase();if("armed_home"===e||"home"===e)return"arm_home";if("armed_away"===e||"away"===e)return"arm_away"}const r=e.previous_state;return"armed_home"===r?"arm_home":"arm_away"}return"disarming"===t?"disarm":null}static calculateProgress(t,e){if(e<=0)return 100;if(t<0)return 100;if(t>=e)return 0;const r=(e-t)/e*100;return Math.max(0,Math.min(100,r))}static captureInitialDuration(t){return Math.max(0,t)}static createTransitionState(t,e){return{isTransitioning:null!==t,targetAction:t,totalDuration:yt.captureInitialDuration(e),remainingSeconds:e,progress:0,startTime:Date.now()}}static createEmptyState(){return{isTransitioning:!1,targetAction:null,totalDuration:0,remainingSeconds:0,progress:0,startTime:0}}}const vt=[s`
    :host {
      display: block;
    }
...
`];function _t(t,e){if(t?.states)return t.states[e]}let bt=class extends st{constructor(){super(...arguments),this.buttonStates=new Map,this.transitionState=yt.createEmptyState(),this._transitionTotalDuration=0,this._lastClickedAction=null}static{this.styles=vt}_initializeButtonStates(){const t=gt.getControlActions(),e=new Map;for(const r of t)e.set(r.type,{isActive:!1,isLoading:!1,isDisabled:!1,hasError:!1});this.buttonStates=e}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this._initializeButtonStates()}_updateButtonState(t,e){const r=this.buttonStates.get(t)||{isActive:!1,isLoading:!1,isDisabled:!1,hasError:!1},i=new Map(this.buttonStates);i.set(t,{...r,...e}),this.buttonStates=i}_clearButtonError(t){setTimeout(()=>{this._updateButtonState(t,{hasError:!1})},3e3)}async _handleControlButtonClick(t){if(this.hass&&this.config?.entity){this._lastClickedAction=t,this._updateButtonState(t,{isLoading:!0,hasError:!1});try{const e=gt.getServiceForAction(t);await this.hass.callService("alarm_control_panel",e,{entity_id:this.config.entity}),this._updateButtonState(t,{isLoading:!1})}catch(e){this._updateButtonState(t,{isLoading:!1,hasError:!0}),this._clearButtonError(t)}}}setConfig(t){ut.validateConfig(t),this.config=ut.mergeConfig(t),this.entityError=void 0,this.alarmState=void 0,this.hass&&this._validateAndInitializeEntity()}getCardSize(){return 2}updated(t){super.updated(t),t.has("hass")&&this._handleHassUpdate(t.get("hass"))}_handleHassUpdate(t){this.hass&&(t||!this.config?t&&t!==this.hass&&(this.config?.entity&&function(t,e,r){const i=_t(t,r),a=_t(e,r);return!((i||!a)&&(!i||a)&&(!i&&!a||i.state===a.state&&i.last_updated===a.last_updated))}(t,this.hass,this.config.entity)&&this._handleEntityStateChange(),t.selectedTheme!==this.hass.selectedTheme&&this._handleThemeChange()):this._validateAndInitializeEntity())}_handleThemeChange(){this.requestUpdate()}_handleEntityStateChange(){if(!this.config?.entity||!this.hass)return;const t=this.hass.states[this.config.entity];if(!t)return this.entityError=`entity_not_found:${this.config.entity}`,this.alarmState=void 0,void this._clearTransitionState();if("unavailable"===t.state)return this.entityError=`entity_unavailable:${this.config.entity}`,this.alarmState=void 0,void this._clearTransitionState();if(pt.isValidAlarmEntity(t)){const e=this.alarmState?.state;this.alarmState=pt.mapEntityState(t),this.entityError=void 0,this._handleTransitionStateChange(this.alarmState.state,t.attributes,e)}else{const t=this.config.entity.split(".")[0];this.entityError=`wrong_domain:${this.config.entity}:${t}`,this.alarmState=void 0,this._clearTransitionState()}}_handleTransitionStateChange(t,e,r){const i=yt.isTransitionalState(t),a=!!r&&yt.isTransitionalState(r),o=e.exitSecondsLeft??e.exit_seconds_left??e.delay??e.seconds_left??0;if(i){let i=yt.getTransitionTarget(t,e);"arming"!==t||"arm_away"!==i||!this._lastClickedAction||"arm_home"!==this._lastClickedAction&&"arm_away"!==this._lastClickedAction||(i=this._lastClickedAction);const n=!a||r!==t,s=this.transitionState.isTransitioning&&this.transitionState.targetAction!==i;if(n||s)this._transitionTotalDuration=yt.captureInitialDuration(o),this.transitionState=yt.createTransitionState(i,o);else{const t=yt.calculateProgress(o,this._transitionTotalDuration);this.transitionState={...this.transitionState,remainingSeconds:o,progress:t}}}else a&&this._clearTransitionState()}_clearTransitionState(){this._transitionTotalDuration=0,this._lastClickedAction=null,this.transitionState=yt.createEmptyState()}_validateAndInitializeEntity(){if(this.config?.entity&&this.hass)try{ut.validateEntityExists(this.hass,this.config.entity);const t=this.hass.states[this.config.entity];if(t&&pt.isValidAlarmEntity(t))this.alarmState=pt.mapEntityState(t),this.entityError=void 0,this._handleTransitionStateChange(this.alarmState.state,t.attributes,void 0);else{const t=this.config.entity.split(".")[0];this.entityError=`wrong_domain:${this.config.entity}:${t}`,this.alarmState=void 0,this._clearTransitionState()}}catch(t){const e=t instanceof Error?t.message:"Unknown entity validation error";if(e.includes("not found"))this.entityError=`entity_not_found:${this.config.entity}`;else if(e.includes("unavailable"))this.entityError=`entity_unavailable:${this.config.entity}`;else if(e.includes("domain")){const t=this.config.entity.split(".")[0];this.entityError=`wrong_domain:${this.config.entity}:${t}`}else this.entityError=e;this.alarmState=void 0,this._clearTransitionState()}}render(){if(!this.config)return W`
        <div class="card">
          <div class="content">
    ...
    `}_renderControlButtons(){if(!this.hass||!this.config?.entity)return W``;const t=this._getButtonStatesWithTransition(),e=this.transitionState.isTransitioning?ft.generateTransitionAnnouncement(this.alarmState?.state??"unknown",this.transitionState.targetAction):void 0;return ft.renderControlButtons(this.alarmState,t,t=>this._handleControlButtonClick(t),e)}_getButtonStatesWithTransition(){const t=new Map;for(const[e,r]of this.buttonStates){this.transitionState.isTransitioning&&this.transitionState.targetAction===e?t.set(e,{...r,isTransitionTarget:!0,transitionProgress:this.transitionState.progress,transitionRemainingSeconds:this.transitionState.remainingSeconds}):t.set(e,{...r,isTransitionTarget:!1})}return t}_renderSpecificError(t){if(t.startsWith("entity_not_found:")){const e=t.split(":")[1]??"unknown";return ft.renderEntityNotFound(e)}if(t.startsWith("entity_unavailable:")){const e=t.split(":")[1]??"unknown";return ft.renderEntityUnavailable(e)}if(t.startsWith("wrong_domain:")){const e=t.split(":"),r=e[1]??"unknown",i=e[2]??"unknown";return ft.renderWrongEntityDomain(r,i)}if(t.startsWith("config_error:")){const e=t.substring(13);return ft.renderConfigurationError(e)}return ft.renderErrorState(t)}};t([mt({attribute:!1}),e("design:type",Object)],bt.prototype,"hass",void 0),t([ht(),e("design:type",Object)],bt.prototype,"config",void 0),t([ht(),e("design:type",Object)],bt.prototype,"alarmState",void 0),t([ht(),e("design:type",Object)],bt.prototype,"entityError",void 0),t([ht(),e("design:type",Map)],bt.prototype,"buttonStates",void 0),t([ht(),e("design:type",Object)],bt.prototype,"transitionState",void 0),bt=t([(t=>(e,r)=>{void 0!==r?r.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("ring-alarm-card")],bt),window.customCards=window.customCards||[],window.customCards.push({type:"ring-alarm-card",name:"Ring Alarm Card",description:"A custom card for Ring alarm systems",preview:!0,documentationURL:"https://github.com/your-repo/ring-alarm-card#readme",version:"0.1.0"});export{ut as ConfigurationManager,bt as RingAlarmCard};
