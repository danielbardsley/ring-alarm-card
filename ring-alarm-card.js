...
compact_mode: false</pre
    ...
    `}static generateAriaLabel(t,e){const r={disarm:"Set alarm to disarmed",arm_home:"Arm alarm in home mode",arm_away:"Arm alarm in away mode"}[t.type];if(e.isTransitionTarget&&void 0!==e.transitionRemainingSeconds){const r=Math.ceil(e.transitionRemainingSeconds);return`${"disarm"===t.type?"Disarming":"arm_home"===t.type?"Arming home":"Arming away"} - ${r} second${1!==r?"s":""} remaining`}return r}}class yt{static isTransitionalState(t){return["arming","pending","disarming"].includes(t)}static getTransitionTarget(t,e){if(!yt.isTransitionalState(t))return null;if("arming"===t){const t=e.next_state;return"armed_home"===t?"arm_home":"arm_away"}if("pending"===t){const t=e.previous_state;return"armed_home"===t?"arm_home":"arm_away"}return"disarming"===t?"disarm":null}static calculateProgress(t,e){if(e<=0)return 100;if(t<0)return 100;if(t>=e)return 0;const r=(e-t)/e*100;return Math.max(0,Math.min(100,r))}static captureInitialDuration(t){return Math.max(0,t)}static createTransitionState(t,e){return{isTransitioning:null!==t,targetAction:t,totalDuration:yt.captureInitialDuration(e),remainingSeconds:e,progress:0,startTime:Date.now()}}static createEmptyState(){return{isTransitioning:!1,targetAction:null,totalDuration:0,remainingSeconds:0,progress:0,startTime:0}}}const vt=[s`
    :host {
      display: block;
    }
